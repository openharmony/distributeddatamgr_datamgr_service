...
constexpr int E_RELATIONAL_SCHEMA_NOT_FOUND = (E_BASE + 202); // Schema was not found in relational distributed tables
constexpr int E_RELATIONAL_SCHEMA_CHANGED = (E_BASE + 203); // Schema has change when do sync
} // namespace DistributedDB
