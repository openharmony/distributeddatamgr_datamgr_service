...
public:
    ...
    int32_t GetSubProfileIdByToken(uint32_t tokenId, int32_t &subProfileId) override;
    int32_t GetForegroundSubProfileId(int32_t osAccountId, int32_t &subProfileId) override;
