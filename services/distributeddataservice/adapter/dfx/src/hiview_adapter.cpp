...
void HiViewAdapter::ReportDBFault(int dfxCode, const DBFaultMsg &msg, std::shared_ptr<ExecutorPool> executors)
{
    ...
    ExecutorPool::Task task([dfxCode, msg]() {
        struct HiSysEventParam params[] = {
            { .name = { *APP_ID },
                .t = HISYSEVENT_STRING,
                .v = { .s = const_cast<char *>(Anonymous::Change(msg.appId).c_str()) },
                .arraySize = 0 },
            { .name = { *STORE_ID },
                .t = HISYSEVENT_STRING,
...
void HiViewAdapter::ReportDbSize(const StatisticWrap<DbStat> &stat)
{
    ...
    struct HiSysEventParam params[] = {
        ...
        { .name = { *APP_ID },
            .t = HISYSEVENT_STRING,
            .v = { .s = const_cast<char *>(Anonymous::Change(stat.val.appId).c_str()) },
            .arraySize = 0 },
        { .name = { *STORE_ID },
            .t = HISYSEVENT_STRING,
...
void HiViewAdapter::InvokeTraffic()
{
    ...
    for (auto const &kv : trafficStat_) {
        ...
        struct HiSysEventParam params[] = {
            ...
            { .name = { *APP_ID },
                .t = HISYSEVENT_STRING,
                .v = { .s = const_cast<char *>(Anonymous::Change(kv.second.val.appId).c_str()) },
                .arraySize = 0 },
            { .name = { *DEVICE_ID },
                .t = HISYSEVENT_STRING,
