...
private:
    ...
    static bool CheckNode(JsonObject &Node, std::set<std::string> fieldSet, bool &errFlag);
    static bool CheckProjectionNode(JsonObject &Node, std::set<std::string> fieldSet, bool &errFlag,
