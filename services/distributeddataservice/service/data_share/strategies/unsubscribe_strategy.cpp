 ...
 */
#define LOG_TAG "UnsubscribeStrategy"
...
int32_t UnsubscribeStrategy::Execute(std::shared_ptr<Context> context, std::function<int32_t()> process)
{
...
SeqStrategy &UnsubscribeStrategy::GetStrategy()
{
