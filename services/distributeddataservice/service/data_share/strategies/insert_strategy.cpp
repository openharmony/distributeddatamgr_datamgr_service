...
int64_t InsertStrategy::Execute(std::shared_ptr<Context> context, const DataShareValuesBucket &valuesBucket)
{
    ...
    return delegate->Insert(context->calledTableName, valuesBucket);
}

SeqStrategy &InsertStrategy::GetStrategy()
{
