...
#ifndef OHOS_DISTRIBUTEDDATA_SERVICE_TEST_RDB_GENERAL_STORE_H
#define OHOS_DISTRIBUTEDDATA_SERVICE_TEST_RDB_GENERAL_STORE_H
#include <atomic>
#include <functional>
...
class GeneralStoreMock : public DistributedData::GeneralStore {
public:
    explicit GeneralStoreMock(const StoreMetaData& meta);
    ~GeneralStoreMock();
    ...
    int32_t OnChange(const GeneralWatcher::Origin& origin, const GeneralWatcher::PRIFields& primaries,
...
#endif // OHOS_DISTRIBUTEDDATA_SERVICE_TEST_RDB_GENERAL_STORE_H
