...
public:
    ...
    virtual bool Sync(const std::vector<std::string> &, MetaDataManager::OnComplete, bool) = 0;
...
public:
    ...
    MOCK_METHOD(bool, Sync, (const std::vector<std::string> &, MetaDataManager::OnComplete, bool), (override));
};
