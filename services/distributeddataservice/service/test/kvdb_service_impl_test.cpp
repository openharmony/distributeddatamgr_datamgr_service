...
/**
* @tc.name: ResolveAutoLaunch_IdentifierMatch
* @tc.desc: Test ResolveAutoLaunch with identifier match
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, ResolveAutoLaunch_IdentifierMatch, TestSize.Level0)
{
    StoreId id;
    id.storeId = "identifier_match_test";
    Status status = manager.GetSingleKvStore(create, appId, id, kvStore);
    EXPECT_NE(kvStore, nullptr);
    EXPECT_EQ(status, Status::SUCCESS);
    ...
    auto identifierTag = DistributedDB::KvStoreDelegateManager::GetKvStoreIdentifier(
        "", meta.appId, meta.storeId, true);

    DistributedKv::KVDBServiceImpl::DBLaunchParam launchParam;
    launchParam.userId = "user1";

    auto result = kvdbServiceImpl_->ResolveAutoLaunch(identifierTag, launchParam);
    EXPECT_EQ(result, Status::SUCCESS);
}

/**
* @tc.name: ResolveAutoLaunch_TripleIdentifierEqualWithNullStore
* @tc.desc: Test ResolveAutoLaunch with triple identifier equal but store is null
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, ResolveAutoLaunch_TripleIdentifierEqualWithNullStore, TestSize.Level0)
{
    StoreId id;
    id.storeId = "triple_null_test";
    Status status = manager.GetSingleKvStore(create, appId, id, kvStore);
    EXPECT_NE(kvStore, nullptr);
    EXPECT_EQ(status, Status::SUCCESS);
    ...
    auto identifierTag = DistributedDB::KvStoreDelegateManager::GetKvStoreIdentifier(
        accountId, meta.appId, meta.storeId, false);
...
/**
* @tc.name: ResolveAutoLaunch_TripleIdentifierEqualWithValidStore
* @tc.desc: Test ResolveAutoLaunch with triple identifier equal and store is valid
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, ResolveAutoLaunch_TripleIdentifierEqualWithValidStore, TestSize.Level0)
{
    StoreId id;
    id.storeId = "triple_valid_test";
    Status status = manager.GetSingleKvStore(create, appId, id, kvStore);
    EXPECT_NE(kvStore, nullptr);
    EXPECT_EQ(status, Status::SUCCESS);
...
/**
* @tc.name: ResolveAutoLaunch_WatchersNotEmpty
* @tc.desc: Test ResolveAutoLaunch with watchers not empty
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, ResolveAutoLaunch_WatchersNotEmpty, TestSize.Level0)
{
    StoreId id;
    id.storeId = "watchers_test";
    Status status = manager.GetSingleKvStore(create, appId, id, kvStore);
    EXPECT_NE(kvStore, nullptr);
    EXPECT_EQ(status, Status::SUCCESS);
...
/**
* @tc.name: ResolveAutoLaunch_EmptyUserId
* @tc.desc: Test ResolveAutoLaunch with empty userId
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, ResolveAutoLaunch_EmptyUserId, TestSize.Level0)
{
    StoreId id;
    id.storeId = "empty_user_test";
    Status status = manager.GetSingleKvStore(create, appId, id, kvStore);
    EXPECT_NE(kvStore, nullptr);
    EXPECT_EQ(status, Status::SUCCESS);
...
/**
* @tc.name: ResolveAutoLaunch_MultipleStores
* @tc.desc: Test ResolveAutoLaunch with multiple stores
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, ResolveAutoLaunch_MultipleStores, TestSize.Level0)
{
    StoreId id;
    id.storeId = "multi_store_test";
    Status status = manager.GetSingleKvStore(create, appId, id, kvStore);
    EXPECT_NE(kvStore, nullptr);
    EXPECT_EQ(status, Status::SUCCESS);
    ...
    std::vector<StoreMetaData> datas;
    StoreMetaData meta1;
    meta1.storeType = StoreMetaData::StoreType::STORE_KV_BEGIN;
    meta1.user = "user1";
    meta1.appId = "test_app1";
    meta1.storeId = "test_store1";
    meta1.tokenId = TOKENID1;
    datas.push_back(meta1);

    StoreMetaData meta2;
    meta2.storeType = StoreMetaData::StoreType::STORE_KV_BEGIN;
    meta2.user = "user1";
    meta2.appId = "test_app2";
    meta2.storeId = "test_store2";
    meta2.tokenId = TOKENID2;
    datas.push_back(meta2);

    StoreMetaData meta3;
    meta3.storeType = StoreMetaData::StoreType::STORE_KV_END;
    meta3.user = "user1";
    meta3.appId = "test_app3";
    meta3.storeId = "test_store3";
    meta3.tokenId = TOKENID1;
    datas.push_back(meta3);

    EXPECT_CALL(*metaDataMock, LoadMeta(testing::_, testing::_, testing::_))
        .WillRepeatedly(testing::DoAll(testing::SetArgReferee<1>(datas), testing::Return(true)));

    auto identifierTag1 = DistributedDB::KvStoreDelegateManager::GetKvStoreIdentifier(
        "", meta1.appId, meta1.storeId, true);

    DistributedKv::KVDBServiceImpl::DBLaunchParam launchParam;
    launchParam.userId = "user1";

    auto result = kvdbServiceImpl_->ResolveAutoLaunch(identifierTag1, launchParam);
    EXPECT_EQ(result, Status::SUCCESS);
}
} // namespace DistributedDataTest
} // namespace OHOS::Test
