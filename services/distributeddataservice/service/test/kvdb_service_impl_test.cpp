...
/**
* @tc.name: NotifyDataChange_001
* @tc.desc: test NotifyDataChange LoadMeta success.
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, NotifyDataChange_001, TestSize.Level1)
{
    EXPECT_CALL(*metaDataManagerMock, LoadMeta(testing::_, testing::_, testing::_)).WillOnce(testing::Return(true));
    StoreId id1;
    id1.storeId = "id1";
    auto status = kvdbServiceImpl_->NotifyDataChange(appId, id1, 0);
    EXPECT_EQ(status, Status::SUCCESS);
}

/**
* @tc.name: NotifyDataChange_002
* @tc.desc: test NotifyDataChange LoadMeta failed.
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, NotifyDataChange_002, TestSize.Level1)
{
...
/**
* @tc.name: SetConfig_001
* @tc.desc: test SetConfig LoadMeta success and SaveMeta success.
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, SetConfig_001, TestSize.Level1)
{
    EXPECT_CALL(*metaDataManagerMock, LoadMeta(testing::_, testing::_, testing::_))
        .WillOnce(testing::Return(true))
        .WillOnce(testing::Return(true))
        .WillOnce(testing::Return(true));
    EXPECT_CALL(*metaDataManagerMock, SaveMeta(testing::_, testing::_, testing::_))
        .WillOnce(testing::Return(true))
        .WillOnce(testing::Return(true));
    StoreId id1;
    id1.storeId = "id1";
    DistributedKv::StoreConfig config;
    auto status = kvdbServiceImpl_->SetConfig(appId, id1, config);
    EXPECT_EQ(status, Status::SUCCESS);
}

/**
* @tc.name: SetConfig_002
* @tc.desc: test SetConfig LoadMeta success and SaveMeta failed.
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, SetConfig_002, TestSize.Level1)
{
    EXPECT_CALL(*metaDataManagerMock, LoadMeta(testing::_, testing::_, testing::_))
        .WillOnce(testing::Return(true))
        .WillOnce(testing::Return(true))
...
/**
* @tc.name: SetConfig_003
* @tc.desc: test SetConfig LoadMeta failed.
* @tc.type: FUNC
*/
HWTEST_F(KvdbServiceImplTest, SetConfig_003, TestSize.Level1)
{
    EXPECT_CALL(*metaDataManagerMock, LoadMeta(testing::_, testing::_, testing::_))
        .WillOnce(testing::Return(true))
        .WillOnce(testing::Return(true))
        .WillOnce(testing::Return(false));
    EXPECT_CALL(*metaDataManagerMock, SaveMeta(testing::_, testing::_, testing::_)).WillOnce(testing::Return(true));
    StoreId id1;
    id1.storeId = "id1";
    DistributedKv::StoreConfig config;
    auto status = kvdbServiceImpl_->SetConfig(appId, id1, config);
