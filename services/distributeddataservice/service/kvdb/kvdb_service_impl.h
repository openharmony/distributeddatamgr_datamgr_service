...
public:
    ...
    int32_t OnFeatureExit(pid_t uid, pid_t pid, uint32_t tokenId, const std::string &appId) override;
...
private:
    ...
    bool IsValidParam(const AppId &appId, const StoreId &storeId, const std::string &baseDir,
