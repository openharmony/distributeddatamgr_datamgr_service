...
public:
    ...
    int32_t SetAppShareOption(const std::string &intention, const std::string &shareOption) override;
    int32_t GetAppShareOption(const std::string &intention, std::string &shareOption) override;
